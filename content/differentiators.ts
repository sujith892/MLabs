...
export const differentiators: Differentiator[] = [
  ...
  {
    n: "04",
    title: "Augmenting Potential",
    body: "We apply AI not merely as a tool, but as a catalyst that elevates human performance.",
    narrative:
      "We pair responsible AI with human judgment, freeing teams to focus on higher-value work. The outcome: a more productive, more capable organization.",
    image: "/logo/typing-on-laptop-with-artificial-intelligence-conc-2026-03-18-11-53-22-utc.jpg",
  },
  {
    n: "05",
    title: "Enabling Evolution",
    body: "We implement technology as a foundation for continuous business evolution.",
    narrative:
      "We build ecosystems designed to adapt as markets shift and priorities change. The outcome: an organization that improves continuously, not periodically.",
    image: "/logo/woman-contemplates-global-commerce-in-modern-world-2026-04-13-23-53-03-utc.jpg",
  },
];
